...
<div class="pt-[80px] min-h-screen max-w-4xl mx-auto px-4">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div class="rounded-[10px] border border-gray-200 bg-white/80 p-5 shadow-sm">
            ...
            <a href="{{ route('editMyProfile') }}" class="mt-5 inline-block rounded-[10px] btn-red px-4 py-2 text-sm font-medium text-whiteCustom hover:shadow-[inset_3px_3px_5px_rgb(56,58,59)] transition duration-200 ease-in">
                Edit profile
            </a>
        </div>
        ...
        <div class="rounded-[10px] border border-gray-200 bg-white/80 p-5 shadow-sm">
            ...
            <a href="{{ route('showMyRentals') }}" class="mt-5 inline-block rounded-[10px] btn-red px-4 py-2 text-sm font-medium text-whiteCustom hover:shadow-[inset_3px_3px_5px_rgb(56,58,59)] transition duration-200 ease-in">
                View all my rentals
            </a>
        </div>
    </div>
