...
<nav x-data="{ open: false }" id="top_nav" class="flex justify-between h-[70px] bg-darkGray fixed w-full z-10 max-[900px]:bg-transparent max-[900px]:flex max-[900px]:justify-center max-[900px]:content-center max-[900px]:flex-col max-[900px]:absolute">
    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 flex justify-between">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <x-nav-link :href="route('showMyProfile')" :active="request()->routeIs('showMyProfile')">
                My Profile
            </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-darkGray text-white z-50 absolute top-[70px] left-0 w-full p-4">
        ...
        <div class="pt-4 pb-1 border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('showMyProfile')">
                    My Profile
                </x-responsive-nav-link>
